...
const showTabbar = computed(() => {
  // 在登录页、任务详情页、邀请人列表页、名片列表页、设置页、个人信息编辑页、名片详情页、钱包页和结算账单页不显示底部导航
  return !['Login', 'TaskDetail', 'Invites', 'Social', 'Settings', 'ProfileEdit', 'SocialDetail', 'Wallet', 'WalletBills'].includes(route.name)
})
</script>
