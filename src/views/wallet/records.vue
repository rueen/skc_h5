          ...
          <div :class="$style.recordList">
            ...
            >
              ...
              <div :class="$style.reason" v-if="record.withdrawalStatus === 'failed'">
                ...
                <span v-else-if="['Insufficient balance of merchant','Not added to the api whitelist','API调用异常: 支付API无响应: timeout of 30000ms exceeded'].indexOf(record.rejectReason) > -1">error occurred. Please try again later.</span>
                <span v-else-if="record.rejectReason.indexOf('502 Bad Gateway') > -1">error occurred. Please try again later.</span>
